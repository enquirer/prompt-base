# Contributing to enquirer-prompt

First and foremost, thank you! We appreciate that you want to contribute to enquirer-prompt, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for enquirer-prompt**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for enquirer-prompt:

- star the [project](https://github.com/jonschlinkert/enquirer-prompt)
- tweet your support for enquirer-prompt
...
- **version**: please note the version of enquirer-prompt are you using
...
[so]: http://stackoverflow.com/questions/tagged/enquirer-prompt